      ...
      case "NP"://投屏命令：["NP",\""+uname+"\",["+x+","+y+","+r+","+s+"],\""+f+"\","+c+"]
         ...
         */
         ...
         if(nId>-1)//在当前项目中已经存在该选手，则直接更新选手的坐标、方向和大小数据。
         {
             ...
             case 1:
                oGUI.props.vm.runtime.targets[nId].setXY(jsonCOMMAND[3][0],jsonCOMMAND[3][1]);	//设置角色坐标
             break;

             case 2:
                oGUI.props.vm.runtime.targets[nId].setDirection(jsonCOMMAND[3]);		//设置角色方向
             break;

             case 3:
                oGUI.props.vm.runtime.targets[nId].setSize(jsonCOMMAND[3]);			//设置角色大小
             break;
             ...
             case 5:
                oGUI.props.vm.runtime.targets[nId].setEffect(jsonCOMMAND[3][0],jsonCOMMAND[3][1]);				//设置颜色特效
             break;
...
/*
             ...
             //oGUI.props.vm.runtime.targets[1].setEffect('color',46);				//设置颜色特效
