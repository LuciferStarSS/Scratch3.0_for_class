...
var bSelfShow=false;
   var Quiz=Array(
      ...
      "[\"QUIZ\",[\"2\",\"画图程序中，“用颜色填充”工具，单击左键，可以用如下颜色进行填充：<br>A:前景色。<BR>B:背景色。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，“用颜色填充”工具，单击右键，可以用如下颜色进行填充：<br>A:前景色。<BR>B:背景色。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，“放大镜”工具，单击左键，可以对编辑区进行：<br>A:放大。<BR>B:缩小。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，“放大镜”工具，单击右键，可以对编辑区进行：<br>A:放大。<BR>B:缩小。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，“颜色选取器”工具，单击左键，可以将目标颜色吸取到：<br>A:颜色1。<BR>B:颜色2。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，“颜色选取器”工具，单击右键，可以将目标颜色吸取到：<br>A:颜色1。<BR>B:颜色2。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，要想使复制的图形不包含某一个颜色，可以：<br>A:先设置颜色1为要过滤的颜色，再选中“透明选择”菜单。<BR>B:先设置颜色2为要过滤的颜色，再选中“透明选择”菜单。\"]]",


      "[\"QUIZ\",[\"2\",\"画图程序中，“颜色1”表示：<br>A:前景色。<BR>B:背景色。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，“颜色2”表示：<br>A:前景色。<BR>B:背景色。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，“颜色1”将应用于：<br>A:图形的外框或线条。<BR>B:封闭图形内部的填充区域。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，“颜色2”将应用于：<br>A:图形的外框或线条。<BR>B:封闭图形内部的填充区域。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，以下操作，哪个可以最精确快速地调整绘图区的尺寸大小：<br>A:拖拽绘图区右侧或底部或右下角的白色小方块。<BR>B:使用“主页”中的“重新调整大小”。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，用“橡皮擦”的时候，越擦颜色越多，是因为哪个颜色的设置问题？<br>A:颜色1<BR>B:颜色2\"]]",
      "[\"QUIZ\",[\"4\",\"画图程序中，撤销操作可以撤销：<br>A:1次<BR>B:3次<BR>C:无数次<BR>D:缓存区大小固定，实际次数由每次增加的内容的大小所决定。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，在“查看”里可以设置网格线。在保存文件时，这个网格线：<br>A:不会被保存到文件中，它只是辅助你确定要画图形的起笔位置。<BR>B:会被保存到文件中，它是图形的一部分。\"]]",
      "[\"QUIZ\",[\"2\",\"画图程序中，在“查看”里可以设置标尺。标尺显示的数据，比“任务栏”左下角显示的坐标更：<br>A:精确<BR>B:模糊\"]]",
